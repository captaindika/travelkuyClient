            ...
            <Container>
              <View
                ...
                <Text
                  ...
                  {this.props.Detail.detail && this.props.Detail.detail.name}
                </Text>
              </View>
              <View
                style={{
                ...
                <View
                  ...
                  <Text
                    ...
                    {this.props.Detail.detail && this.props.Detail.detail.email}
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <Text
                    ...
                    {this.props.Detail.detail && this.props.Detail.detail.phone}
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <Text
                    ...
                    {this.props.Detail.detail &&
                      this.props.Detail.detail.balance}
                  </Text>
                </View>
              </View>
              <View
